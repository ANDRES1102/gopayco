...
<?php 
mysql_select_db($database_gopayco, $gopayco);
$query_pregunta = "INSERT INTO preguntas_seguridad(pregunta_preguntas_seguridad, respuesta_preguntas_seguridad, 	estado_preguntas_seguridad, user_preguntas_seguridad)VALUES('".$_GET['pregunta']."', '".$_GET['respuesta']."', 'activo', '".$row_user['user_user']."')";
...
<meta http-equiv="refresh" content="1;URL=preguntas.php" />
