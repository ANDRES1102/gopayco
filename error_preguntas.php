  ...
  <div data-role="content">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>Respuesta incorrecta, iniciamos nuevamente</p></td>
      </tr>
      <tr>
        <td align="center"><form name="form1" method="post" action="recuperar_clave.php?e=none">
          <input type="submit" name="button" id="button" value="Intentar Nuevamente">
        </form></td>
      </tr>
    </table>
  </div>
